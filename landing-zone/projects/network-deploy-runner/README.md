...
| <a name="input_portfolio_id"></a> [portfolio\_id](#input\_portfolio\_id) | ID of the Service Catalog portfolio (e.g. port-xxxx). Wired from bootstrap-parameters outputs via the propeller pipeline. Used for the principal association. | `string` | n/a | yes |
