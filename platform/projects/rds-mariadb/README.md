...
Deploys an RDS MariaDB instance with managed credentials via Secrets Manager,
...
- **RDS MariaDB instance** with storage autoscaling
...
Setting `engine_version` to the major number (e.g. `"10.11"`) lets RDS auto-select
...
- Aurora MySQL/MariaDB clusters — use a dedicated aurora project
...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_rds_mariadb"></a> [rds\_mariadb](#module\_rds\_mariadb) | ../../../shared/modules/rds-mariadb | n/a |
...
| <a name="input_engine_version"></a> [engine\_version](#input\_engine\_version) | MariaDB major version (e.g. '10.11'). | `string` | `"10.11"` | no |
