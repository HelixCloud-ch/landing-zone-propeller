...
# single target account. Called by terraform local-exec with environment
# variables set for the target account. Runs from the management account and
# assumes AWSControlTowerExecution into the target.
